            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm animate-in fade-in duration-500">
              <div className="flex flex-col items-center gap-4 bg-card p-8 rounded-lg border-4 border-primary animate-in zoom-in-95 duration-500 max-w-md mx-4">
                ...
                {transactionStatus === 'pending' && (
                  <>
                    <Loader2 className="w-16 h-16 animate-spin text-primary" />
                    <p className="text-lg font-bold font-mono text-primary animate-pulse">Preparing Transaction...</p>
                    <p className="text-sm text-muted-foreground font-mono text-center">Fetching your jetton wallet</p>
                  </>
                )}
                ...
                {transactionStatus === 'confirming' && (
                  <>
                    <Loader2 className="w-16 h-16 animate-spin text-primary" />
                    <p className="text-lg font-bold font-mono text-primary animate-pulse">Confirm Transaction</p>
                    <p className="text-sm text-muted-foreground font-mono text-center">Please approve the transaction in your wallet</p>
                    <div className="flex gap-2 mt-2">
                      <div className="w-2 h-2 bg-primary rounded-full animate-bounce" style={{ animationDelay: '0ms' }}></div>
                      <div className="w-2 h-2 bg-primary rounded-full animate-bounce" style={{ animationDelay: '150ms' }}></div>
                      <div className="w-2 h-2 bg-primary rounded-full animate-bounce" style={{ animationDelay: '300ms' }}></div>
                ...
                {transactionStatus === 'success' && (
                  <>
                    ...
                    <p className="text-lg font-bold font-mono text-primary">Transaction Successful!</p>
                    <p className="text-sm text-muted-foreground font-mono text-center">Entering battle arena...</p>
                  </>
                )}
                  ...
                  <>
                    ...
                    <div className="flex flex-col gap-3 mt-4 w-full">
                      ...
                      <div className="flex gap-3">
                        {getTransactionErrorDetails(transactionError).canRetry && (
                          <Button onClick={handleRetryTransaction} variant="outline" className="flex-1">
                            Try Again
                          </Button>
                        )}
                        <Button onClick={() => router.push('/battle')} variant="outline" className="flex-1">
                          Back to Battles
                        </Button>
                      </div>
                    </div>
